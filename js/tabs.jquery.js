...
(function( $ ) {
    ...
    var elitTabsConfig = {
        ...
        'topOffsetSlideTo': 100 // отступ от верза окна до верха активного слайда при прокрутке методом slideToElement (например при переходе к табу по параметам в адресной строке)
    };
    ...
    $.fn.elitTabs = function(options) {
        ...
        return this.each(function(){
            ...
            $TABS_LINKS.delegate(elitTabsConfig.tabsLinkSelector + ':not(' + elitTabsConfig.currentLinkSelector + ')', 'click', function(e) {
                e.preventDefault();
